...
(() => {
  ...
  function makeTexture(kind){
    ...
    if(kind==='website'){
      ...
      ['Code','Build','Test','Deploy','Observe'].forEach((s,i)=>{const x=213+i*158;rect(x,162,138,148,'#1b2d3e',16);if(i<4)line([x+93,211],[x+187,211],'#84c6c2',2);g.fillStyle='#a3d6ce';g.beginPath();g.arc(x+68,211,16,0,Math.PI*2);g.fill();text('✓',x+61,217,18,'#163839',600);text(s,x+37,277,18,'#b9cfe0');});
