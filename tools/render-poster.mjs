...
await page.waitForFunction(() => window.__story.progress > 0.999, null, { timeout: 15000 });
await page.waitForTimeout(800);
await page.addStyleTag({ content: '.story-copy, .story-rail, .story-cue, .topbar, .scroll-progress { visibility: hidden !important; }' });
