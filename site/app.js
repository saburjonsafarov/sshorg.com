...
const translations = {
  ru: {
    ...
    how_spec: 'Сначала спека с критериями приёмки, потом код. Требования фиксируются до реализации — меньше переделок, меньше сюрпризов.',
    how_agents_title: 'ИИ-агенты — часть команды',
    how_agents: 'Работаю с ИИ-агентами каждый день: они пишут и исследуют, я ставлю задачу, направляю и ревьюю. Для важных решений — панель независимых агентов и судей.',
    ...
    how_bar: 'ИИ ускоряет, но не решает: тесты, статанализ и финальное слово в ревью остаются за инженером.',
  ...
  tg: {
    ...
    how_spec: 'Аввал спека бо меъёрҳои қабул, баъд код. Талабот пеш аз иҷро муайян мешавад — камтар аз нав коркунӣ, камтар ногаҳонӣ.',
    how_agents_title: 'Агентҳои ЗС — қисми даста',
    how_agents: 'Ҳар рӯз бо агентҳои зеҳни сунъӣ кор мекунам: онҳо менависанд ва таҳқиқ мекунанд, ман вазифа мегузорам, роҳнамоӣ ва баррасӣ мекунам. Барои қарорҳои муҳим — панели агентҳо ва доварони мустақил.',
    ...
    how_bar: 'ЗС суръат мебахшад, аммо қарор намедиҳад: тестҳо, таҳлили статикӣ ва сухани охирин дар ревью аз они муҳандис аст.',
    edu_title: 'Таҳсилот',
  ...
  en: {
    ...
    how_spec: 'Acceptance criteria first, implementation second. Requirements are pinned down before the code — fewer reworks, fewer surprises.',
    how_agents_title: 'AI agents on the team',
    how_agents: 'I work with AI agents every day: they write and research, I set the task, steer and review. Big decisions go through a panel of independent agents and judges.',
    ...
    how_bar: 'AI speeds things up but does not decide: tests, static analysis and the final word in review belong to the engineer.',
    edu_title: 'Education',
