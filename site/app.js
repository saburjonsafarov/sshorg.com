...
const translations = {
  ru: {
    ...
    hl_build: 'Сократил время сборки проекта с 10–15 минут до 1 минуты; модернизировал Gradle: buildSrc → build-logic, convention plugins и non-transitive R.',
    ...
    impact_title: 'Лидерство и команда',
    impact_intro: 'В core-команде Eskhata Online выполняю функции тимлида и техлида: помогаю разработчикам, участвую в технических решениях и развиваю процессы мобильной разработки.',
    impact_hiring_title: 'Найм и онбординг',
    impact_hiring: 'За последние два года проводил технические собеседования с местными и зарубежными Android-разработчиками. Участвовал в найме более 10 зарубежных специалистов, проводил онбординг и оценку компетенций разработчиков.',
    impact_arch_title: 'Архитектура и экспертиза',
    impact_arch: 'Проектировал решения для сложных задач, работал над общей навигацией и внедрением новой дизайн-системы. Консультировал другие команды и неоднократно проводил аудит SDK внешних вендоров.',
    impact_delivery_title: 'Релизы и процессы',
    impact_delivery: 'Создал единый стандарт GitFlow для Android- и iOS-проектов банка, развивал CI/CD мобильного приложения. Выполнял обязанности Release Manager и Scrum Master.',
    impact_quality_title: 'Качество и развитие продукта',
    impact_quality: 'Участвовал в тестировании приложения, представлял фичи команды на Demo Day, предлагал и внедрял улучшения.',
    ...
    p_navkit: 'KMP-движок навигации в духе Jetpack Navigation 3: аннотация @Destination на сериализуемом ключе экрана — и KSP генерирует граф, матчеры диплинков и связку с хостом. Ядро — чистый Kotlin; работает с Compose, Fragment и Activity, а граф приложения выпускается markdown-документом в git с проверкой в CI.',
    p_scanner: 'Сканер QR-кодов для Kotlin/Compose Multiplatform, написанный с нуля без ML Kit и ZXing: свой бинаризатор, Рид-Соломон над GF(256), поиск искателей и гомография. Ядро не зависит ни от камеры, ни от UI — и целиком тестируется на чистой JVM.',
    stack_title: 'Стек',
  ...
  tg: {
    ...
    hl_build: 'Вақти сохтани лоиҳаро аз 10–15 дақиқа то 1 дақиқа кам кардам; танзимоти Gradle-ро навсозӣ кардам: buildSrc → build-logic, convention plugins ва non-transitive R.',
    ...
    impact_title: 'Роҳбарӣ ва даста',
    impact_intro: 'Дар дастаи асосии Eskhata Online вазифаҳои роҳбари даста ва роҳбари техникиро иҷро мекунам: ба таҳиягарон кумак мерасонам, дар қабули қарорҳои техникӣ иштирок мекунам ва равандҳои таҳияи барномаҳои мобилиро такмил медиҳам.',
    impact_hiring_title: 'Ҷалб ва омодасозии кормандон',
    impact_hiring: 'Дар ду соли охир бо таҳиягарони маҳаллӣ ва хориҷии Android мусоҳибаҳои техникӣ гузаронидам. Дар ба кор қабул кардани зиёда аз 10 мутахассиси хориҷӣ саҳм гузоштам, кормандони навро бо лоиҳа ва равандҳои кор шинос кардам ва малакаҳои техникии таҳиягаронро арзёбӣ намудам.',
    impact_arch_title: 'Меъморӣ ва дониши техникӣ',
    impact_arch: 'Барои масъалаҳои мураккаби техникӣ роҳҳалҳо тарҳрезӣ кардам, дар таҳияи низоми умумии паймоиши барнома ва ҷорӣ кардани низоми нави тарроҳӣ иштирок кардам. Ба дастаҳои дигар машварат додам ва SDK-и таъминкунандагони берунаро борҳо аз санҷиши техникӣ гузаронидам.',
    impact_delivery_title: 'Нашри версияҳо ва равандҳои кор',
    impact_delivery: 'Барои лоиҳаҳои Android ва iOS-и бонк стандарти ягонаи GitFlow таҳия кардам ва CI/CD-и барномаи мобилиро такмил додам. Вазифаҳои масъули нашри версияҳо ва ҳамоҳангсози равандҳои Scrum-ро иҷро кардам.',
    impact_quality_title: 'Сифат ва рушди маҳсулот',
    impact_quality: 'Дар санҷиши барнома иштирок кардам, имкониятҳои таҳиякардаи дастаамонро дар Demo Day муаррифӣ кардам, беҳбудиҳо пешниҳод ва амалӣ намудам.',
    ...
    p_navkit: 'Муҳаррики навигатсияи KMP дар рӯҳияи Jetpack Navigation 3: аннотатсияи @Destination ба калиди сериализатсияшавандаи экран — ва KSP граф, матчерҳои диплинк ва пайвандро бо хост тавлид мекунад. Ядро — Kotlin-и холис; бо Compose, Fragment ва Activity кор мекунад, графи замима ҳамчун ҳуҷҷати markdown дар git бо санҷиш дар CI нашр мешавад.',
    p_scanner: 'Сканери QR-кодҳо барои Kotlin/Compose Multiplatform, аз сифр бе ML Kit ва ZXing навишташуда: бинаризатори худӣ, Рид-Соломон дар GF(256), ҷустуҷӯи нақшҳои ёбанда ва гомография. Ядро на ба камера ва на ба UI вобаста нест — ва пурра дар JVM-и тоза санҷида мешавад.',
    stack_title: 'Стек',
  ...
  en: {
    ...
    hl_build: 'Reduced project build time from 10–15 minutes to 1 minute; modernized the Gradle setup: buildSrc → build-logic, convention plugins, and non-transitive R.',
    ...
    impact_title: 'Leadership and team',
    impact_intro: 'Within Eskhata Online’s core team, I take on team lead and technical lead responsibilities: supporting developers, contributing to technical decisions, and improving mobile development processes.',
    impact_hiring_title: 'Hiring and onboarding',
    impact_hiring: 'Over the past two years, I conducted technical interviews with local and international Android developers. I contributed to hiring more than 10 international developers, onboarded new team members, and assessed developers’ technical skills.',
    impact_arch_title: 'Architecture and expertise',
    impact_arch: 'Designed solutions to complex engineering challenges and worked on application-wide navigation and the adoption of a new design system. Advised other teams and conducted multiple audits of third-party SDKs.',
    impact_delivery_title: 'Releases and processes',
    impact_delivery: 'Established a shared GitFlow standard for the bank’s Android and iOS projects and improved the mobile application’s CI/CD. Took on Release Manager and Scrum Master responsibilities.',
    impact_quality_title: 'Quality and product development',
    impact_quality: 'Contributed to application testing, presented the team’s features at Demo Day, and proposed and implemented improvements.',
    ...
    p_navkit: 'A KMP navigation engine in the spirit of Jetpack Navigation 3: annotate a serializable screen key with @Destination and KSP generates the graph, deep-link matchers and host bindings. The core is pure Kotlin; it works with Compose, Fragments and Activities, and the app graph is emitted as a markdown document kept in git and checked in CI.',
    p_scanner: 'A QR code scanner for Kotlin/Compose Multiplatform written from scratch with no ML Kit and no ZXing: my own binarizer, Reed–Solomon over GF(256), finder-pattern search and homography. The core depends on neither the camera nor the UI — and is fully tested on plain JVM.',
    stack_title: 'Stack',
